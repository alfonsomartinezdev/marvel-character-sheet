    ...
    },
    {
      ...
      rewards: [
        ...
        },
        {
          xp: 3,
          description:
            "when you publicly defend a teammate's controversial decision",
        },
        {
          xp: 10,
      ...
      sfx: [
        {
          name: "Area Attack",
          description:
            "Target multiple opponents. For every additiona, target, add d6 and keep +1 effect die.",
        },
        {
          name: "Versatile",
          description:
            "Replace Gorilla Strength power with a 2d8 or a 3d6 on your next roll",
        },
      ],
      limits: [
        {
          ...
          description:
            "Add Enhanced Durability die to the opposing roll when others try to recover your physical stress",
        },
      ],
    },
  ],
  ...
  milestones: [
    {
      ...
      rewards: [
        ...
        {
          xp: 10,
          description: "When you embrace your animal side and save someone",
        },
      ],
    },
  ],
